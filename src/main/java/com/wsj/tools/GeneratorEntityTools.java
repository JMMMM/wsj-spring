...
public class GeneratorEntityTools {
    ...
    //数据库连接
    private static final String URL ="jdbc:mysql://192.168.0.102:3306/new_wsj";
...
//          }
    ...
    private void processAllAttrs(StringBuffer sb) {
        ...
        for (int i = 0; i < colnames.length; i++) {
            ...
            sb.append("\tprivate " + sqlType2JavaType(colTypes[i]) + " " + underlineToCamel(colnames[i]) + ";\r\n");
        }
    ...
    private void processAllMethod(StringBuffer sb) {
        ...
        for (int i = 0; i < colnames.length; i++) {
            ...
            sb.append("\t}\r\n");
            sb.append("\tpublic " + sqlType2JavaType(colTypes[i]) + " get" + initcap(underlineToCamel(colnames[i])) + "(){\r\n");
